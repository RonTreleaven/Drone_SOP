C:\Users\Ron Treleaven\Drone_SOP\Python_Code 
...
# TODO Filter toggle button to switch Filtered/RAW .json arrays
# default to RAW in maps... 
# ==============================
# Imports Global
# ==============================
import html
...
def build_map(pilot_lat, pilot_lon, notams_filtered, notams_raw, generated_at=None):
    ...
    m.get_root().html.add_child(
        folium.Element(
            ...
            ".home-logo-control img{display:block;height:32px;width:auto;}"
...
window.onload = function() {{
  ...
  function updateSourceDisplay() {{
      ...
      if (sourceBtn) {{
          sourceBtn.textContent = 'NOTAM Filter';
      }}
  }}
...
###  1.0 Next Item in OUTLINE format
