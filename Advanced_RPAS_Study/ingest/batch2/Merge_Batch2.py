#!/usr/bin/env python3
"""Merge Batch 2 reviewed questions into Advanced_RPAS_Study/data/questions.json.

Usage:
    python Merge_Batch2.py --dry-run
    python Merge_Batch2.py
...
def main():
    ...
    fragment_path = script_path.with_name("Batch2_questions_merge_fragment.json")
    ...
    print(f"Batch 2: {len(fragment['questions'])} reviewed merge candidates")
    ...
    backup_path = backup_dir / f"questions_before_batch_2_{stamp}.json"
    ...
    migration_note = '2026-09-03 CHAT BATCH 2: Added reviewed TP 15263 core-Advanced questions; semantic duplicates and Level 1 Complex/BVLOS-specific items excluded.'
